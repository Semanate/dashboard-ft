      ...
      <div class="space-y-6">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <span class="block text-sm font-medium text-gray-700 mb-1">ID</span>
            ...
            {/if}
            <div>
              <span class="block text-sm font-medium text-gray-700 mb-1">Fecha de registro</span>
              <div class="text-sm text-gray-900 bg-white px-3 py-2 rounded border">
        ...
        <div>
          ...
          >
            {#each roleOptions as option}
              <option value={option.value} selected={data.user.role === option.value}>
                {option.label}
              </option>
            {/each}
          </select>
